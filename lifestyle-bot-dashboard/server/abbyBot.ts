/**
 * abbyBot.ts — Abby's Lifestyle Bot
 * Agent: Abby Martinez (FUB ID: 28)
...
const BOT_NAME = "Abby's Lifestyle Bot";
const BOT_SLUG = "abby";
const OBSERVATION_SOURCE = "abby_bot";

const AGENT_FUB_ID = 28;
const AGENT_FIRST = "Abby";
const AGENT_LAST = "Martinez";
const AGENT_EMAIL = "Abby@lifestyledesignrealty.com";

export async function runAbbyBot(): Promise<{
  sent: number;
  errored: number;
  skipped: number;
}> {
...
export async function sendAbbyBotClockinEmail(): Promise<void> {
  let leadsQueued = 0;
...
export async function sendAbbyBotClockoffEmail(
